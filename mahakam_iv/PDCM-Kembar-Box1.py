...
localFolder = [
    '/home/shms/ftp/2003-kembar-box1/strandmeter/',
    '/home/shms/ftp/2003-kembar-box1/dmm/',
    '/home/shms/ftp/2003-kembar-box1/temperature/',
    '/home/shms/ftp/2003-kembar-box1/all/',
]
...
class MyEventHandler(pyinotify.ProcessEvent):
    ...
    def process_IN_CLOSE_WRITE(self, event):
        ...
        if "strandmeter" in full_file_name:
            sensorType = 'strandmeter'
        elif "dmm" in full_file_name:
            sensorType = 'dmm'
        elif "temperature" in full_file_name:
            sensorType = 'temperature'
        elif "BattTemp" in full_file_name:
